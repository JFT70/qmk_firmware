...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [0] = LAYOUT_60_ansi(
        ...
        KC_LCTL, KC_LALT, KC_LGUI,                           SPC_FN2,                             KC_RALT, MO(1),   KC_APP,  KC_RCTL
    ),

    [1] = LAYOUT_60_ansi(
        ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___,
        ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, ___T___, QK_BOOT,
        ...
        ___T___, ___T___, ___T___,                            KC_MPLY,                             ___T___, ___T___, ___T___, ___T___
   ),
    ...
    [2] = LAYOUT_60_ansi(
        ...
        ___T___,          ___T___, ___T___, ___T___, ___T___, CTL_RGT, ___T___, ___T___, ___T___, ___T___, ___T___,          ___T___,
        ___T___, ___T___, ___T___,                            ___T___,                            ___T___, ___T___, ___T___, ___T___
    ),
